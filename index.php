...
if($ageEnfant>=12){
    echo "Categorie : Cadet<br>";
} elseif ($ageEnfant == 11 or $ageEnfant == 10){
    echo "Categorie : Minime<br>";
}elseif ($ageEnfant == 9 or $ageEnfant == 8){
    echo "Categorie : Pupille<br>";
}elseif ($ageEnfant == 6 or $ageEnfant == 7){
    echo "Categorie : Poussin<br>";
}else{
    echo "Categorie indetermine<br>";
}
...
<?php
    ...
    Class Personne{
       ...
       public function CalculerAge (){
        ...
        $interval = $dateDeNaissance->diff($aujourdhui);
...
echo $p1->getNom()." ".  $p1->getPrenom()." ". $p1->CalculerAge()." ans." ."<br>";
echo $p2->getNom()." ".  $p2->getPrenom()." ". $p2->CalculerAge()." ans.";
